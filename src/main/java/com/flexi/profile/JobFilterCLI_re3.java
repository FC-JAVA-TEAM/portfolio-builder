...
public class JobFilterCLI_re3 {
    ...
    private static String buildPrompt(Map<String, String> filters, String jobsJsonArray) {
       ...
       // prompt.append("Return a valid JSON array with no explanation or markdown and no sub array \n\n");
    ...
    private static String extractResponse(ObjectMapper mapper, String responseBody) throws Exception {
        ...
        if (choices.isArray() && choices.size() > 0) {
            ...
            try {
            	...
            	System.err.println("Error parsing JSON response: " + ex.getMessage());
